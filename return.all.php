    ...
    <main class="content">
        ...
        <div class="py-3">
            ...
            <div class="d-flex justify-content-between w-100 flex-wrap align-items-center">
                <h1 class="h4 mb-0">All Returns</h1>
                <div class="btn-group">
                    <a href="return.add.php" class="btn btn-outline-gray-800 d-inline-flex align-items-center">
                ...
                <table class="table table-flush table-hover" id="datatable">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="border-0">Return From.</th>
                            <th class="border-0 text-center">Location / Property</th>
                            <th class="border-0 text-end">Charges</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <span class="text-success">Received Amount: <strong>Rs. 1,000,000</strong></span><br />
                                <span class="text-success">Other Charges: <strong>Rs. -20,000</strong></span><br />
                                <span class="text-danger">Payable Amount: <strong>Rs. 980,000</strong></span><br />
                            </td>
                            <td>
                                <br />
