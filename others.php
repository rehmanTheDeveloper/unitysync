    ...
    <main class="content">
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1"
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center"
                                                                href="comp/others.delete.php?i=<?=encryptor("encrypt", $group['id'])?>&type=expenseSubGroup">
                                                ...
                                                <td class="text-end">
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1"
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center"
                                                                href="comp/others.delete.php?i=<?=encryptor("encrypt", $block['id'])?>&type=block">
                                                                <svg class="icon icon-xs dropdown-icon text-success me-2"
                                                                    fill="currentColor" viewBox="0 0 20 20"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <path fill-rule="evenodd"
        ...
        <div class="modal fade" id="addSubGroup" tabindex="-1" role="dialog" aria-labelledby="Expense Sub Group"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="modal">
                <form method="POST" action="comp/others.add.php" class="modal-content">
